...
/*
* Creating "Projects" Custom Post Type
*/
...
function custom_post_type() {
	...
	// Set other options for Custom Post Type
		...
		$args = array(
			...
			'show_in_rest'        => true, // API Support is set to true
			'description'         => __( 'Projects for Ikonic Dev Task', 'twentytwentyone' ),
			'labels'              => $labels,
...
// Add API Search support for endpoints
...
register_nav_menus( array(
	'primary' => __( 'Top Main Menu', 'THEMENAME' ),
) );